...
import cismStuCerti from "../assets/images/indi_course/cisa.png";
import criscStuCerti from "../assets/images/indi_course/cisa.png";
...
export const isacaCourses = {
  ...
  CISM: {
    // Basic Course Information
    title: "Certified Information Systems Manager (CISM) Course in Chennai",
    badge: "Very Famous",
    rating: {
      stars: 5,
      text: "Top Rating | Read Reviews",
    ...
    description: {
      intro:
        "Are you looking for an affordable Certified Information Systems Manager (CISM) course with ISACA certification to improve your  Cyber Auditing skills..?",
      brochureLink: {
        text: "Click here to download the CISM brochure and syllabus  ",
        url: "https://docs.google.com/document/d/1DX1GebrrWpKDNzokvdg92ZXXK1HthFvWEXp1jDIUgeU/edit?usp=sharing",
      },
    ...
    additionalInfoHeading:
      "Why Certified Information Systems Manager (CISM) course in Zero2infynite is best among others.",
    additionalInfoSubHeading:
      "Learn (CISM) Anytime, Anywhere through online and offline",
    // Additional Information
    additionalInfo:
      "Certified Information Systems Manager (CISM) from Zero2infynite offers ISSACA International certification to upskill your Cyber knowledge. This CRISC course will help you to get high salary and promotions in cyber security domain. Our Trainers trained Cyber crime officers from various states, managers in IT industry, College and school students.",
    ...
    certifications: {
      title: "Certifications",
      rightSideImage: cismStuCerti,
      sections: [
        {
          title: "ISSACA CISM certification and Exams",
          content: [
            "We are the only institute offering low-cost ISSACA CISM certification with placement assistance, career shift guidance, hands-on training, and industry-standard curriculum. All our students have successfully cleared their exams. We've updated the EC-Council license image and a sample EC-Council certificate on this page for your reference. Students who opt for training only will receive customized sessions along with a Zero2infynite certification.",
            "We've updated the EC-Council license image and a sample EC-Council certificate on this page for your reference. Students who opt for training only will receive customized sessions along with a Zero2infynite certification.",
          ],
          image: {
            src: cismStuCerti,
  ...
  CRISC: {
    // Basic Course Information
    title:
      "ISACA Certified in Risk and Information Systems Control (CRISC) Course in Chennai",
    badge: "Very Famous",
    rating: {
      stars: 5,
      text: "Top Rating | Read Reviews",
    ...
    description: {
      intro:
        "Are you looking for an affordable ISACA Certified in Risk and Information Systems Control (CRISC) course with ISACA certification to improve your  Cyber Auditing skills..?",
      brochureLink: {
        text: "Click here to download the CRISC brochure and syllabus  ",
        url: "https://docs.google.com/document/d/1_PRzN5kO6dTfY1-MwCTQOz6Eivq8DX-xLY2e4kj4oI8/edit?usp=sharing",
      },
    ...
    additionalInfoHeading:
      "Why ISACA Certified in Risk and Information Systems Control (CRISC) course in Zero2infynite is best among others.",
    additionalInfoSubHeading:
      "Learn (CRISC) Anytime, Anywhere through online and offline",
    // Additional Information
    additionalInfo:
      "ISACA Certified in Risk and Information Systems Control (CRISC) from Zero2infynite offers ISSACA International certification to upskill your Cyber knowledge. This CRISC course will help you to get high salary and promotions in cyber security domain. Our Trainers trained Cyber crime officers from various states, managers in IT industry, College and school students.",
    ...
    certifications: {
      title: "Certifications",
      rightSideImage: criscStuCerti,
      sections: [
        {
          title: "ISSACA CRISC certification and Exams",
          content: [
            "We are the only institute offering low-cost ISSACA CRISC certification with placement assistance, career shift guidance, hands-on training, and industry-standard curriculum. All our students have successfully cleared their exams. We've updated the EC-Council license image and a sample EC-Council certificate on this page for your reference. Students who opt for training only will receive customized sessions along with a Zero2infynite certification.",
            "We've updated the EC-Council license image and a sample EC-Council certificate on this page for your reference. Students who opt for training only will receive customized sessions along with a Zero2infynite certification.",
          ],
          image: {
            src: criscStuCerti, // Will be imported in component
            alt: "Certification Image",
            className: "certification-image",
          },
        },
